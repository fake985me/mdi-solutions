<template>
  <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex w-full max-w-screen-xl mx-auto py-8 px-4 lg:py-16 lg:px-6">
      <div class="justify-center items-center max-w-6xl mx-10">
        <h3 class="text-2xl text-center font-bold mb-4 text-gray-900 pt-14">{{ selectedProduct?.title || product.title
          }}</h3>
        ...
        <div>
          ...
          <div class="w-full max-w-7xl px-4 mt-8">
            <h2 class="text-xl text-center font-semibold mb-2">Overview</h2>
        ...
        <div class="flex flex-col lg:flex-row gap-8 pt-8">
          <div class="flex-1 flex flex-col">
            ...
            <div v-if="features.length">
              <h3 class="text-2xl font-bold mb-4 text-gray-900">Features</h3>
              ...
              <table class="table-auto w-full text-sm text-gray-700 border-collapse">
                <tbody>
                  <tr>
                    ...
                    <td class="border-b border-gray-800 px-2 py-1">{{ selectedProduct?.flashmemory ||
                      product.flashmemory
                    }}</td>
                  </tr>
                  <tr>
                    <td class="font-semibold border-b border-r border-gray-800 px-2 py-1">SDRAM Memory</td>
                    <td class="border-b border-gray-800 px-2 py-1">{{ selectedProduct?.sdrammemory ||
                      product.sdrammemory
                    }}</td>
                  </tr>
