...
const specificationList = computed(() => {
  ...
  return [
    ...
    { label: 'Interface', value: [p.Interface, p.Interface1, p.Interface2, p.Interface3, p.Interface4].filter((i) => i) },
    { label: 'Control Unit', value: [p.cu, p.cu1, p.cu2, p.cu3, p.cu4].filter((i) => i)},
