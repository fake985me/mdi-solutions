...
const specificationList = computed(() => {
  ...
  return [
    { label: 'Wireless Standard', value: p.wirelessStandard },
    { label: 'Wireless Stream', value: [p.wirelessStream, p.wirelessStream1, p.wirelessStream2, p.wirelessStream3, p.wirelessStream4, p.wirelessStream5].filter((i) => i) },
    { label: 'client Capacity', value: p.capacity },
    { label: 'Antena', value: p.antena },
    { label: 'Interface', value: [p.Interface1, p.Interface2, p.Interface3, p.Interface4].filter((i) => i) },
    { label: 'IP Rating', value: p.iprating },
    ...
    { label: 'Power Consumption', value: p.powercomsumptions },
