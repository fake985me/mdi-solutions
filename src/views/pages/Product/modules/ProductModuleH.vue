...
const specificationList = computed(() => {
  ...
  return [
    { label: 'Number of manageable APs', value: p.manageableAps },
    { label: 'Maximum configurable AP number', value: p.APnumber },
    { label: 'Maximum Number Of Clients', value: p.numberOfClients },
